...
File::Util also doesn't offer unicode support yet.  If you want to write files
in UTF-8 encoding, File::Util won't do that for you.  This will not always be
the case, but for the time being it is a limitation.
