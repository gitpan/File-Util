...
The syntax and keywords available to use for this method are already disussed
...
or to write the file with UTF-8 encodeding, specify a value of B<C<utf8>> to this
option.  I<(see L<perlfunc/binmode>)>.
