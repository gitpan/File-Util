...
=item I<Syntax:> C<< open_handle('file' => [file name], [ 'mode' => [mode], 'bitmask' => [bitmask], 'dbitmask' => [bitmask], [--opts]) >>
...
native C<open()>.  Unless you use the C<--use-sysopen> flag, the following modes
and only these modes are valid.
...
=item I<Syntax:> C<< write_file('file' => [file name], 'content' => [string], [ 'mode' => [mode], 'bitmask' => [bitmask], 'dbitmask' => [bitmask], [--opts]) >>
